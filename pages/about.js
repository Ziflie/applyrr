...
export default function About() {
  return (
    <>
      ...
      <div className="container mx-auto grid grid-cols-4 gap-4 font-main ">
        <div className="col-span-4 grid justify-center pt-12 pb-24 ">
          <picture>
            <img className="w-32 grid justify-center"></img>
          </picture>
        </div>
        ...
        <div className="grid col-span-4 justify-center">
          <h1 className="font-main text-black text-9xl">About applyrr</h1>
        </div>

        <div className="grid col-span-4 pt-24">
          <h1 className="text-black font-main">
